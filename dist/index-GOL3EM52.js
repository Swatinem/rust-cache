...
import { C as CredentialsProviderError, s as setCredentialFeature } from './s3-cache-DBnZf3ob.js';
...
const fromWebToken = (init) => async (awsIdentityProperties) => {
    ...
    if (!roleAssumerWithWebIdentity) {
        const { getDefaultRoleAssumerWithWebIdentity } = await import('./index-BBsoNkTm.js');
