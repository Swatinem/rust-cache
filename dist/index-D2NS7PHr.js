...
import { C as CredentialsProviderError, v as readFile, w as HttpRequest, x as getProfileName, s as setCredentialFeature } from './s3-cache-DBnZf3ob.js';
...
class LoginCredentialsFetcher {
    ...
    async refresh(token) {
        const { SigninClient, CreateOAuth2TokenCommand } = await import('./index-Bvmwolbn.js');
